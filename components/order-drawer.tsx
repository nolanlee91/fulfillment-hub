...
function ReconciliationSection({
  ...
  return (
    <>
      ...
      {role === "CUSTOMER" && (
        <div className="flex items-stretch gap-2 w-full py-2.5">
          <div className="flex-1 min-w-0 space-y-1.5">
            <label
              className="block cursor-pointer px-3 py-1.5 rounded text-[11px] truncate transition-colors"
              style={{
          ...
          <button
            ...
            className="px-3 rounded text-[11px] font-semibold transition-colors disabled:opacity-40 shrink-0 self-stretch"
