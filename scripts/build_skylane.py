# -*- coding: utf-8 -*-
"""Build customer guide docx for Skylane (anonymized screenshots)."""
import os
...
OUT_DIR = os.path.join("Hướng dẫn khách hàng", "2. Skylane")
os.makedirs(OUT_DIR, exist_ok=True)
OUT = os.path.join(OUT_DIR, "Huong dan su dung Fulfillment Hub - Skylane.docx")
...
r.bold = True; r.font.size = Pt(20); r.font.color.rgb = GREEN

sub = doc.add_paragraph(); sub.alignment = WD_ALIGN_PARAGRAPH.CENTER
rs = sub.add_run("KDExpress – Dành cho khách hàng")
rs.font.size = Pt(12); rs.font.color.rgb = RGBColor(0x55, 0x55, 0x55)
