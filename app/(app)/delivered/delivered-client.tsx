    ...
    <>
      ...
      <div className="table-shell">
        {loading ? (
          ...
          <div className="p-12 text-center text-sm" style={{ color: "var(--text-secondary)" }}>Chưa có đơn nào đã giao.</div>
        ) : (
            ...
            <table className="table-base">
              <thead>
                <tr>
                  ...
                  <th className="text-left px-3 py-3 text-[11px] font-bold tracking-widest uppercase">Giao lúc</th>
