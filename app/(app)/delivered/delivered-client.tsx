    ...
    <>
      ...
      <div className="action-bar">
        <div className="text-sm" style={{ color: "var(--text-secondary)" }}>
          <span className="font-bold text-white">{orders.length}</span> delivered orders
        </div>
      ...
      <div className="table-shell">
        {loading ? (
          ...
          <div className="p-12 text-center text-sm" style={{ color: "var(--text-secondary)" }}>No delivered orders yet.</div>
        ) : (
